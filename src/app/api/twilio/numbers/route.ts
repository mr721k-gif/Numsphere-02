...
export async function GET(request: NextRequest) {
  try {
    ...
    // For now, return mock data since we need Twilio credentials
    // In production, you would use actual Twilio API calls
    ...
    return NextResponse.json({ 
      ...
      message: 'Mock data - configure Twilio credentials for live data'
    });
